...
const QUICK_PROMPTS = [
  'Is my hemoglobin level normal for my trimester?',
  'What foods are highest in iron and folate?',
  'Is my blood pressure reading safe?',
  'What are warning signs I should report to my doctor?',
];

const WELCOME: Message = {
  id:      'welcome',
  role:    'assistant',
  content: '🔐 I am analyzing your blockchain-verified records to provide this insight.\n\nHello! I\'m your Maternal Health AI Assistant. I have access to your verified medical records. How can I help you today?\n\n💡 Try asking about your lab values, nutrition needs, or any symptoms you\'re experiencing.',
};
      ...
      <div className="flex items-center gap-3 p-4 border-b border-white/20 cursor-pointer shrink-0"
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            <p className="text-sm font-bold text-foreground">Maternal Health AI</p>
